...
public class FenetreHistorique extends FenetreSecondaire {

	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FenetreHistorique frame = new FenetreHistorique();
